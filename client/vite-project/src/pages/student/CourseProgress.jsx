...
const CourseProgress = () => {
    ...
    const [incompleteCourse, { data: markIncompleteData, isSuccess: incompletedSucess }] = useInCompleteCourseMutation()
    ...
    useEffect(()=>{
        ...
        if(incompletedSucess){
            refetch()
            toast.success(markIncompleteData.message)
        }
    },[completedSuccess, incompletedSucess])
    ...
    return (
        <div className='max-w-7xl mx-auto p-4 mt-20'>
            ...
            <div className='flex flex-col md:flex-row gap-6'>
                ...
                <div className='flex flex-col w-full md:w-2/5 border-t md:border-t-0 md:border-l border-gray-200 md:pl-4 pt-4 md:p-t-0'>
