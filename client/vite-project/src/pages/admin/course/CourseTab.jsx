...
import { useEditeCourseMutation, useGetCourseByIdQuery, usePublishCourseMutation } from '@/features/api/courseApi';
...
const params = useParams();
  ...
  const [editcourse, { data, isLoading, isSuccess, error }] = useEditeCourseMutation()
    ...
    <Card>
      <CardHeader className="flex flex-row justify-between">
        <div>
          ...
          <CardDescription>
            Make changes to your courses here. Click save once you are done Editing.
          </CardDescription>
        </div>
